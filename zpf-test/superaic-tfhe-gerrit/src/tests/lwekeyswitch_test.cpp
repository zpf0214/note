...
namespace {
    ...
    const LweParams *params500_0 = new_LweParams(500, plaintext_modulus, 0., 1.);
    const LweParams *params500_1em5 = new_LweParams(500, plaintext_modulus, 1e-5, 1.);
...
#include "../libtfhe-superaic-core/lwe-keyswitch-functions.cpp"
    };
