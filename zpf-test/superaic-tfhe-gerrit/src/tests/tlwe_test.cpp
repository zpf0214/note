...
namespace {
     ...
     */
    const TLweParams *params512_1 = new_TLweParams(512, 1, plaintext_modulus, 0., 1.);
    const TLweParams *params512_2 = new_TLweParams(512, 2, plaintext_modulus, 0., 1.);
    const TLweParams *params1024_1 = new_TLweParams(1024, 1, plaintext_modulus, 0., 1.);
    const TLweParams *params1024_2 = new_TLweParams(1024, 2, plaintext_modulus, 0., 1.);
    const TLweParams *params2048_1 = new_TLweParams(2048, 1, plaintext_modulus, 0., 1.);
    const TLweParams *params2048_2 = new_TLweParams(2048, 2, plaintext_modulus, 0., 1.);
