...
int32_t main(int32_t argc, char **argv) {
    ...
    int32_t plaintext_modulus = 2;
    LweParams *params = new_LweParams(512, plaintext_modulus, 0.2, 0.5); //les deux alpha mis un peu au hasard
    int32_t n = params->n;
    ...
    message = lweSymDecrypt(cipher, key, plaintext_modulus);
