...
#undef INCLUDE_TFHE_CREATEBOOTSTRAPPINGKEY
    ...
    #define GENERATE_TFHE_PROGRAMMABLE_BOOTSTRAP_MINUS_TEST(value) \
    TEST_F(TfheCreateBootstrapKeyTest, TFHE_PROGRAMMABLE_BOOTSTRAP_MINUS_TEST_##value) { \
        bool _use_fix_random_bak = _use_fix_random; \
        LweKey *key = new_LweKey(in_params); \
        lweKeyGen(key); \
        TGswKey *key_bk = new_TGswKey(bk_params); \
    ...
    GENERATE_TFHE_PROGRAMMABLE_BOOTSTRAP_MINUS_TEST(1)
    GENERATE_TFHE_PROGRAMMABLE_BOOTSTRAP_MINUS_TEST(2)
    GENERATE_TFHE_PROGRAMMABLE_BOOTSTRAP_MINUS_TEST(3)
    GENERATE_TFHE_PROGRAMMABLE_BOOTSTRAP_MINUS_TEST(4)
    GENERATE_TFHE_PROGRAMMABLE_BOOTSTRAP_MINUS_TEST(5)
    GENERATE_TFHE_PROGRAMMABLE_BOOTSTRAP_MINUS_TEST(6)
    GENERATE_TFHE_PROGRAMMABLE_BOOTSTRAP_MINUS_TEST(7)
    GENERATE_TFHE_PROGRAMMABLE_BOOTSTRAP_MINUS_TEST(8)
