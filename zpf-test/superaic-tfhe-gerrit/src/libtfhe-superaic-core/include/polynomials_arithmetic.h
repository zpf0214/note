...
// #define MUL_TYPE_NAIVE 0
// #define MUL_TYPE_FFT 1
// #define MUL_TYPE_KARATSUB 2

extern std::function <void(TorusPolynomial* , const IntPolynomial* , const TorusPolynomial* poly2)> torusPolynomialAddMulR;
extern std::mutex torusPolynomialAddMulR_mtx;
#if MUL_TYPE == MUL_TYPE_KARATSUB
...
#if MUL_TYPE == MUL_TYPE_NAIVE
#define torusPolynomialMulR torusPolynomialMultNaive
//#define torusPolynomialAddMulR torusPolynomialAddMulRNaive
#define torusPolynomialSubMulR torusPolynomialSubMulRNaive
#endif
