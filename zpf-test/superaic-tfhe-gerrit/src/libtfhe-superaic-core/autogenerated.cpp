...
EXPORT void init_LweParams(LweParams* obj, int32_t n, int32_t plaintext_modulus, double alpha_min, double alpha_max) {
    new(obj) LweParams(n,plaintext_modulus,alpha_min,alpha_max);
}
EXPORT void init_LweParams_array(int32_t nbelts, LweParams* obj, int32_t n, int32_t plaintext_modulus, double alpha_min, double alpha_max) {
    for (int32_t i=0; i<nbelts; i++) {
	new(obj+i) LweParams(n,plaintext_modulus,alpha_min,alpha_max);
    }
}
...
EXPORT LweParams* new_LweParams(int32_t n, int32_t plaintext_modulus, double alpha_min, double alpha_max) {
    return new LweParams(n,plaintext_modulus,alpha_min,alpha_max);
}
EXPORT LweParams* new_LweParams_array(int32_t nbelts, int32_t n, int32_t plaintext_modulus, double alpha_min, double alpha_max) {
    ...
    init_LweParams_array(nbelts,obj,plaintext_modulus,n,alpha_min,alpha_max);
    return obj;
}
...
//initialize the key structure
//(equivalent of the C++ constructor)
EXPORT void init_TLweParams(TLweParams* obj, int32_t N, int32_t k, int32_t plaintext_modulus, double alpha_min, double alpha_max) {
    new(obj) TLweParams(N,k,plaintext_modulus,alpha_min,alpha_max);
}
EXPORT void init_TLweParams_array(int32_t nbelts, TLweParams* obj, int32_t N, int32_t k, int32_t plaintext_modulus, double alpha_min, double alpha_max) {
    for (int32_t i=0; i<nbelts; i++) {
	new(obj+i) TLweParams(N,k,plaintext_modulus,alpha_min,alpha_max);
    }
}
...
EXPORT TLweParams* new_TLweParams_array(int32_t nbelts, int32_t N, int32_t k, int32_t plaintext_modulus, double alpha_min, double alpha_max) {
    ...
    init_TLweParams_array(nbelts,obj,N,k,plaintext_modulus,alpha_min,alpha_max);
    return obj;
}
