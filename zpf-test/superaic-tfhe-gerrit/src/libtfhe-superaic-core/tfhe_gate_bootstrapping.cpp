...
static TFheGateBootstrappingParameterSet *default_80bit_gate_bootstrapping_parameters() {
    ...
    static const int32_t plaintext_modulus = 2;
    ...
    LweParams *params_in = new_LweParams(n, plaintext_modulus, ks_stdev, max_stdev);
    TLweParams *params_accum = new_TLweParams(N, k, plaintext_modulus, bk_stdev, max_stdev);
